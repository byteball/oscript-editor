...
`
	...
	{
		quoted: false,
		label: 'trigger.outputs',
		insertText: 'trigger.outputs',
		kind: monaco.languages.CompletionItemKind.Keyword,
		detail: '`trigger.outputs` external reference',
		documentation: {
			value:
`
	\`{
...
`
	...
	{
		quoted: false,
		label: 'trigger.initial_unit',
		insertText: 'trigger.initial_unit',
		kind: monaco.languages.CompletionItemKind.Keyword,
		detail: '`trigger.initial_unit` external reference',
		documentation: {
			value:
`
...
`
	...
	},
	{
		...
		detail: '`storage_size` external reference',
		documentation: {
			value:
`
...
`
	...
	},
	{
		...
		insertText: 'number_of_responses',
		kind: monaco.languages.CompletionItemKind.Constant,
		detail: '`number_of_responses` external reference',
		documentation: {
			value:
`
...
`
	...
	{
		quoted: false,
		label: 'previous_aa_responses',
		insertText: 'previous_aa_responses',
		kind: monaco.languages.CompletionItemKind.Keyword,
		detail: '`previous_aa_responses` external reference',
		documentation: {
			value:
`
...
`
	...
	},
	{
		...
		kind: monaco.languages.CompletionItemKind.Keyword,
		detail: '`definition` external reference',
		documentation: {
			value:
`
	\`{
...
or as a variable that can be evaluated at deploy time:
	...
	\`{
		$max_complexity = 5;
		$ar2 = map($ar, 3, $remote_aa#$max_complexity.$f);
	}\`
...
or by indicating a base AA that the \`$remote_aa\` is a parameterized AA of:
	...
	\`{
		...
		$ar2 = map($ar, 3, $remote_aa#$base_aa.$f);
	}\`
`
		}
	},
...
`
	...
	},
	{
		...
		insertText: 'split',
		kind: monaco.languages.CompletionItemKind.Function,
		detail: '`split()` devides a string into set of substrings',
		documentation: {
			value:
`
\`split()\` devides a string into set of substrings
